...
var Form = /** @class */ (function () {
    function Form(el, inputs) {
        this.el = el;
        this.inputs = inputs;
        this.el.addEventListener('submit', function (e) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, result, data, err_1;
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            Array
                                ...
                                .forEach(function (el) { return el.textContent = ''; });
                        ...
                        case 3:
                            data = _a.sent();
                            if (data.errors)
                                return [2 /*return*/, this.showErrors(data.errors)];
                            if (data.user)
                                return [2 /*return*/, location.assign('/')];
                            return [3 /*break*/, 5];
                        case 4:
                            err_1 = _a.sent();
